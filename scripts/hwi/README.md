...
sudo hwi mrbz         # mr-bytez: /mr-bytez/projects/infrastructure/hostname/HARDWARE.md
...
- Redundante sudo-Aufrufe entfernt (Script läuft als root)

## Voraussetzungen

- `dmidecode`, `lspci`, `smartctl`, `nvme-cli`
- Optional: `decode-dimms` (i2c-tools) für erweiterte RAM-Infos
- Root-Rechte (sudo)
...
- Parsing-Fixes für RAM-Typ und NVMe-Health
